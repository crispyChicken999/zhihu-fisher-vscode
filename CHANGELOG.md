...
- 回退 Puppeteer中的userDataDir配置，这个设置导致了无法多实例启动浏览器的问题，现已移除该配置，确保在多实例下也能正常启动浏览器。

## [0.4.3] - 2025-09-23

### Bug Fixes

- 修复了 Puppeteer 启动参数中的 `--single-process` 导致在多vscode实例下浏览器无法启动的问题，移除了该参数，确保在多实例下也能正常启动浏览器。

## [0.4.2] - 2025-09-22

### Bug Fixes

- 修复了GIF图片不受媒体显示模式控制的问题，导致了明明不显示图片却仍展示GIF图片的情况，现已修复。
