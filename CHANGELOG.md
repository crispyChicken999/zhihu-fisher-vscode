...
- 新增侧边栏伪装功能，启用后，点击侧边栏链接打开详情页和界面伪装时，会自动伪装侧边栏为模拟的文件列表。可以在详情页-设置面板-功能增强中自定义想要伪装的文件类型，如果不选择则会随机生成。
  ...
  - 伪装的侧边栏顶部有使用说明分别是zhihu-fisher.tips和zhihu-fisher.buymecoffee，意思是使用提示和赞赏支持，鼠标悬浮有操作提示。
  - enjoy~🎉
- 优化了加载中、错误侧边栏item的tooltip文案，使用markdownString更加美观，内容也进行了优化，更加清晰易懂。
- 推荐、热榜、搜索、伪装的侧边栏新增了赞赏入口，点击可以查看赞赏二维码，欢迎各位老板支持开发者喝杯咖啡，感谢您的支持！(づ￣ 3 ￣)づ【用爱发电不易，感谢支持~】
- 调整了相关问题的图标位置，放到了标题后面，更加合理，相关问题嘛就是应该放在标题附近。
- 侧边栏更多操作里面优化了智能伪装模式的操作，可以单独开启/关闭智能伪装模式or侧边栏伪装功能，方便用户操作。

### Bug Fixes

- 修复了特定回答模式下，回答的日期解析有误的问题，原因是知乎修改了DOM结构，已同步。
