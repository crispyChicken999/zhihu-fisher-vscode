...
- 新增沉浸模式下作者信息透明度设置功能，用户可以在外观设置中调整作者信息的透明度，提升阅读体验。
  ...
  - loading界面也会应用透明度设置，确保整体视觉一致性。
- 优化了沉浸模式下作者信息的位置及样式，优先看回答，作者信息收拢到底部的信息栏中，提升了视觉效果和用户体验。
- 优化了关联问题弹窗中的item hover样式，提升了交互体验。
...
- 修复了沉浸模式下作者popover在灰色模式下样式异常的问题，确保在灰色模式下作者信息弹窗的样式与整体页面一致。
...
- 新增沉浸模式下作者信息入口，在内容的前面加上了，作者XXX:，点击可以查看作者的详细信息和关注/取消关注。
