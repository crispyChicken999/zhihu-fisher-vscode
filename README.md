...
12. 支持 **快捷键自定义**，可以根据自己的习惯设置快捷键，按 `。` 打开设置-快捷键进行调整即可
13. 支持 **评论区**（，），可以查看文章/回答的评论内容，同时支持查看评论的子评论
14. 支持 **沉浸模式**（X）【推荐使用 👍】，隐藏其他不重要的信息，只显示问题标题和回答内容
...
20. 支持 **导出为Markdown文件**，方便离线阅读和保存，导出的文件包含了问题标题、描述、回答内容、作者信息、点赞数、评论数等详细信息
