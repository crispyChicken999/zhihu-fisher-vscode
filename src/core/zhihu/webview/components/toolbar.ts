  ...
  public render(): string {
    ...
    return `
      ...
      <div class="fixed-toolbar">
        ...
        <button class="button immersive-button meta-button" tooltip="点赞数：${likeCount}&#010评论数：${commentCount}&#010发布时间：${publishTime}${
      isUpdated ? "&#010更新于：" + updateTime : ""
        ...
        <button class="button immersive-button open-button" onclick="openPage('${
          this.url
        ...
        <button class="button immersive-button favorite-button" onclick="favoriteContent('${
          this.contentToken
        ...
        <button class="button immersive-button copy-button" onclick="copyLink(this,'${
          this.url
