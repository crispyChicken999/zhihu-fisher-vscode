...
function getXZse96(magic) {
  ...
  function ed(offset) {
    ...
    var tp =
      magic ||
      `101_3_3.0+/api/v4/comment_v5/answers/111987734885/root_comment?order_by=score&limit=20&offset=+APARQ9RV9RmPTtr085PfMggbDEu71bJhdao|1745910639`;
  ...
  //   CasperError: None,
  //   WebPage: None,
  //   _Selenium_IDE_Recorder: None,
  //   __driver_unwrapped: None,
  //   __selenium_evaluate: None,
  //   __webdriver_evaluate: None,
  //   _selenium: None,
  //   domAutomation: None,
  //   userAgent:
        ...
        try {
          switch (this.T) {
            ...
            case 278:
              ...
              if (i === "href") {
                // debugger
                (this.C[this.c] = "http://127.0.0.1:5501/index.html"),
                  (this.T += 74);
              } else {
    ...
    var tu = function (tt, te) {
      ...
      tw = function (tt) {
        ...
        for (tr = 0; tr < tt.length; tr += 1)
          ta +=
            ti.charAt(((te = tt.charCodeAt(tr)) >>> 4) & 15) +
            ti.charAt(15 & te);
        return ta;
      },
      t_ = function (tt) {
