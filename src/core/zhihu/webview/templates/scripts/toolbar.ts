...
function getDefaultToolbarConfig() {
  return [
    ...
    { id: 'export', name: '导出Markdown', category: 'tools', visible: true, order: 11, },
    { id: 'immersive', name: '沉浸模式', category: 'function', visible: true, order: 12, },
    { id: 'comments', name: '查看评论', category: 'function', visible: true, order: 13, },
    { id: 'prev-article', name: '上一篇内容', category: 'navigation', visible: true, order: 14, },
    { id: 'next-article', name: '下一篇内容', category: 'navigation', visible: true, order: 15, },
    { id: 'prev-answer', name: '上一个回答', category: 'navigation', visible: true, order: 16, },
    { id: 'next-answer', name: '下一个回答', category: 'navigation', visible: true, order: 17, },
  ];
}
